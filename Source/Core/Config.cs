...
namespace Holo
{
    ...
    public static class Config
    {
        ...
        public static void Init()
        {
            ...
            Minimum_CFH_Rank = byte.Parse(DB.runRead("SELECT minrank FROM system_fuserights WHERE fuseright = 'fuse_receive_calls_for_help'")); Minimum_CFH_Rank = byte.Parse(DB.runRead("SELECT minrank FROM system_fuserights WHERE fuseright = 'fuse_receive_calls_for_help'"));
