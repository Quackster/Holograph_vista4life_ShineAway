...
using Holo.Domain.Rooms.Bots;
using Holo.Domain.Rooms.Items;
...
namespace HolographEmulator.Domain.Rooms
{
    ...
    public class Room
    {
        ...
        /// <summary>
        /// The collection that contains the Bot objects for the bots in this room.
        /// </summary>
        ...
        internal string dynamicUnits
        {
            get
            {
                ...
                foreach (Bot roomBot in _Bots.Values)
        ...
        /// <summary>
        /// Updates the status of a Bot object in room. If the bot is walking, then the bot isn't refreshed immediately but processed at the next cycle of the status thread, to prevent double status strings in @b.
        /// </summary>
        /// <param name="roomBot">The Bot object to update.</param>
        internal void Refresh(Bot roomBot)
        {
            try
            {
                if (roomBot.goalX == -1)
        ...
        /// <summary>
        /// Sends a 'say' chat message from a Bot to the room. Users in a range of 5 squares will receive the message and bob their heads.
        /// </summary>
        /// <param name="sourceBot">The Bot object that sent the message.</param>
        /// <param name="Message">The message that was sent.</param>
        internal void sendSaying(Bot sourceBot, string Message)
        {
        ...
        /// <summary>
        /// Sends a 'shout' chat message from a Bot to the room. All users will receive the message and bob their heads.
        /// </summary>
        /// <param name="sourceBot">The virtualRoomBot object that sent the message.</param>
        /// <param name="Message">The message that was sent.</param>
        internal void sendShout(Bot sourceBot, string Message)
        {
            //sourceBot.handleStatus("talk", "", Message.Length * 190);
        ...
        internal void loadBots()
        {
            ...
            {
                Bot roomBot = new Bot(IDs[i], getFreeRoomIdentifier(), this);
