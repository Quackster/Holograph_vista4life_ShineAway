...
using Holo.Domain.Games.Pathfinding;
namespace Holo.Domain.Rooms.Bots
{
    /// <summary>
    ...
    internal class Bot
    {
        ...
        /// <summary>
        /// Initializes a new Bot object, loading the walk squares, chat texts etc.
        /// </summary>
        ...
        internal Bot(int botID, int roomUID, virtualRoom Room)
        {
        ...
        /// <summary>
        /// Safely shuts this Bot down and tidies up all resources.
        /// </summary>
        internal void Kill()
        {
            try { aiHandler.Abort(); }
