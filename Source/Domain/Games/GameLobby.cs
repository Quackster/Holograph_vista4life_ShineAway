...
namespace Holo.Domain.Games
{
    ...
    internal class GameLobby
    {
        #region Declares
        /// <summary>
        /// The Room object where this lobby is hosted in.
        /// </summary>
        internal Room Room;
        /// <summary>
        ...
        internal GameLobby(Room Room, bool isBattleBall, string rankTitle)
        {
            this.Room = Room;
        ...
        /// <summary>
        /// Clears the games from the game lobby and nulls the Room object.
        /// </summary>
        internal void Clear()
        {
            Games.Clear();
