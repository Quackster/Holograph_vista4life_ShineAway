...
('Holo Hotel', 'Holo', '0', '1', 'en', '24.72.125.96', '21', 'http://localhost/gamedata/texts.txt', 'http://localhost/dcr/v26/vars.txt', 'http://localhost/dcr/v26/habbo.dcr', 'http://localhost/client.php', '1', 5000, 'You can use this to keep notes for yourself, other mods or admins, etc', 1, '');
